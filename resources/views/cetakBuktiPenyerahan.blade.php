  ...
  <body style="margin:15px;" onload="window.print();" >
      ...
      <div class="a" style="margin-bottom: 5px !important">
        ...
        <div class="ttd-wrapper">
            <div class="ttd-item">
                <p>Diterima oleh,</p>
                <p>{{$LubangTanamDetail['nama_petani'] ?? 'Farmer'}}</p>
            </div>
            <div class="ttd-item">
                <p>Diserahkan oleh,</p>
                <p>{{$LubangTanamDetail['nama_ff'] ?? 'Field Facilitator'}}</p>
            </div>
            <div class="ttd-item">
                <p>Mengetahui,</p>
                <p>{{$fcData['name'] ?? 'Field Coordinator'}}</p>
            </div>
        </div>
      </div>
