                ...
                <tbody id="tableSO">
                    @foreach ($lahan->data as $rslt)
                        <tr>
                            ...
                            <td>{{$rslt->access_lahan}}</td>
                            <td>{{$rslt->jarak_lahan}} m<sup>2</sup></td>
                            <td>{{$rslt->address}}</td>
                            <td>{{$rslt->planting_hole_date}}</td>
                            <td>{{$rslt->distribution_date}}</td>
                            <td>{{$rslt->planting_realization_date}}</td>
                            <td style="background: <?= $rslt->is_verified > 0 ? '#34eb52' : '#ff6052'; ?>">{{$rslt->is_verified ? 'Sudah' : 'Belum'}}</td>
