                ...
                <td style="width: 60%;font-size:14px!important;text-align: left;vertical-align: top;padding: 0px;" >
                    <table style="margin: 0px;">
                        <tr>
                            ...
                            <td><strong><?php echo e($val['ff_name']); ?></strong></td>
                        </tr>
                        <tr>
                            <td style="vertical-align: top">Lahan</td>
                            <td style="vertical-align: top">:</td>
                            <td><strong><?php echo e($val['lahan_no']); ?></strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3"><h2 style="margin-bottom: 0px;text-align: left;padding-left: 5px"><?php echo e($val['farmer_name']); ?></h2></td>
                        </tr>
                    </table>
                </td>
                <td style="width: 40%;font-size:17px!important;text-align: end;border: 2px solid black;border-radius:10px;">
                    ...
                    <?php else: ?>
                        <div style="text-align: center;">
                            <p style="margin-top: 0px"><?php echo e($val['tree_name'][0]); ?></p>
                            <h1 style="margin-bottom: 0px"><?php echo e($val['amount'][0]); ?></h1>
                        </div>
                    <?php endif; ?>
                </td>
            </tr>
        ...
        <table style="width: 100%; height: 45%;">
          <tr style="width: 100%;">
            <td style="max-width:30%!important;font-size:17px!important;border: 2px solid black;vertical-align: middle;text-align: center;border-radius: 10px;position: relative;z-index: 2;"  >
                <h2 style="margin: 0px;"><?php echo e($val['bag_no']); ?></h2>
            </td>
            <td style="width:70%;position: relative;">
            	<img alt="Barcode" src="https://products.aspose.app/barcode/embed/image.Png?BarcodeType=Code128&Content=<?php echo e($val['bag_code']); ?>&Height=123&Width=457" style="transform: scale(.6);position: absolute;bottom: -10px;right: -103px;" />
            </td>
          </tr>
        </table>
      </div>
...
</html><?php /**PATH /home/koly7738/public_html/T4T/root/resources/views/cetakLabelLubangTanamTemp.blade.php ENDPATH**/ ?>