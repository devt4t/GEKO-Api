        ...
        <table style="width: 100%; height: 45%; padding-left: 7px;">
          <tr>
            ...
            <td style="font-size:17px!important" >
              <small>PIC T4T : <?php echo e($lubangTanamDetail->employee_name ?? '-'); ?></small> <br>
              <small>Lahan : <?php echo e($val['lahan_no']); ?></small> <br>
              <small>Tanggal : <?php echo e(date('d F Y', strtotime($lubangTanamDetail->distribution_date) )); ?></small> <br>
            </td>
          </tr>
        </table>
      </div>
...
</html><?php /**PATH /home/koly7738/public_html/T4T/root/resources/views/cetakLabelUmumLubangTanam.blade.php ENDPATH**/ ?>