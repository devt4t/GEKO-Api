<html>
  <head>
    <title>Cetak Tanda Terima #<?php echo e($LubangTanamDetail['nama_petani']); ?></title>
    <style>
        @media  print {
          .thcls1 {
  ...
  <body style="margin:15px;" onload="window.print();" >
      ...
      <div class="a" style="margin-bottom: 5px !important">
        ...
        <table style="width: 100%; margin-left:20px; padding-left: 7px;">
          <tr>
            ...
            <td style="font-size: 16px; font-weight: 900;text-decoration: underline;">
              <?php echo e($listvalbag[0]['farmer_name'] ?? '-'); ?>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
              <?php echo e($listvalbag[0]['ff_name'] ?? '-'); ?>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
              <?php echo e($listvalbag[0]['location'] ?? '-'); ?>
        ...
        <div class="ttd-wrapper">
            <div class="ttd-item">
                <p>Diterima oleh,</p>
                <p><?php echo e($LubangTanamDetail['nama_petani'] ?? 'Farmer'); ?></p>
            </div>
            <div class="ttd-item">
                <p>Diserahkan oleh,</p>
                <p><?php echo e($LubangTanamDetail['nama_ff'] ?? 'Field Facilitator'); ?></p>
            </div>
            <div class="ttd-item">
                <p>Mengetahui,</p>
                <p><?php echo e($fcData['name'] ?? 'Field Coordinator'); ?></p>
            </div>
        </div>
      </div>
...
</html><?php /**PATH /home/koly7738/public_html/T4T/root/resources/views/cetakBuktiPenyerahan.blade.php ENDPATH**/ ?>