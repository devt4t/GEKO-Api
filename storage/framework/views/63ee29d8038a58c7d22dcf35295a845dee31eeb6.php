...
<body>
    ...
    <?php
        ...
        $nama = 'Export Lahan Umum '. $py . '_' .date("Ymd_h-i-s").'.xls';
            ...
            <table class="table" border="1">
                <thead>
                  <tr>
                    ...
                    <th rowspan="2" scope="col">KTP PIC Lahan</th>
                    ...
                    <th rowspan="2" scope="col">Akses Lahan</th>
                    <th rowspan="2" scope="col">Jarak Lahan</th>
                    <th rowspan="2" scope="col">Alamat</th>
                    <th colspan="3" scope="col">Scheduling</th>
                    <th rowspan="2" scope="col">Verifikasi</th>
                    <th colspan="<?= $trees->count ?>" scope="col">Trees Amount</th>
                  </tr>
                  <tr>
                    <th scope="col">Penilikan Lubang</th>
                    <th scope="col">Distribusi</th>
                    <th scope="col">Realisasi Tanam</th>
                ...
                <tbody id="tableSO">
                    <?php $__currentLoopData = $lahan->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rslt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($rslt->access_lahan); ?></td>
                            <td><?php echo e($rslt->jarak_lahan); ?> m<sup>2</sup></td>
                            <td><?php echo e($rslt->address); ?></td>
                            <td><?php echo e($rslt->planting_hole_date); ?></td>
                            <td><?php echo e($rslt->distribution_date); ?></td>
                            <td><?php echo e($rslt->planting_realization_date); ?></td>
                            <td style="background: <?= $rslt->is_verified > 0 ? '#34eb52' : '#ff6052'; ?>"><?php echo e($rslt->is_verified ? 'Sudah' : 'Belum'); ?></td>
...
</html><?php /**PATH /home/koly7738/public_html/T4T/root/resources/views/lahan_umum/export_lahan.blade.php ENDPATH**/ ?>